...
import { Instagram, Leaf, MapPin, Clock, MessageCircle } from "lucide-react";
    ...
    <footer className="mt-20 border-t border-border bg-cream">
      <div className="container-page grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-lg font-semibold">ViveroFlor</span>
          </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/plantas" className="hover:text-primary">Plantas</Link></li>
            <li><Link to="/macetas" className="hover:text-primary">Macetas</Link></li>
            <li><Link to="/accesorios" className="hover:text-primary">Accesorios</Link></li>
            <li><Link to="/categorias" className="hover:text-primary">Categorías</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/preguntas-frecuentes" hash="envios" className="hover:text-primary">Envíos</Link></li>
            <li><Link to="/preguntas-frecuentes" hash="pagos" className="hover:text-primary">Medios de pago</Link></li>
      ...
      <div className="border-t border-border">
        <div className="container-page flex flex-col gap-2 py-5 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          ...
          <p>Pagos procesados de forma segura con Mercado Pago.</p>
        </div>
      </div>
    </footer>
  );
